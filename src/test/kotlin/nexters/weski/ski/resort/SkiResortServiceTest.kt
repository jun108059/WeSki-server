...
class SkiResortServiceTest {
    ...
    private val slopeService: SlopeService = mockk()
    private val skiResortService =
        SkiResortService(
            skiResortRepository,
    ...
    fun `getAllSkiResorts should return list of SkiResortDto`() {
        ...
        every {
            dailyWeatherRepository.findBySkiResortAndForecastDateBetweenOrderByForecastDate(
                any(),
                any(),
                any(),
            )
